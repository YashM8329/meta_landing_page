...
export default function BrochureForm() {
  ...
  if (submitted) {
    return (
      <section id="brochure-form" className="lg:min-h-0 lg:py-20 min-h-dvh flex flex-col justify-center px-6 text-center" aria-label="Confirmation">
  ...
  return (
    <section id="brochure-form" className="lg:min-h-0 lg:py-20 min-h-dvh relative flex flex-col justify-center px-6 lg:px-16 xl:px-24 pt-24 pb-32 overflow-hidden [@media(max-height:900px)]:justify-start" aria-label="Request brochure form">
