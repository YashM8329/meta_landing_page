...
export default function BrochureForm() {
  ...
  return (
    <section id="brochure-form" className="snap-start min-h-dvh relative flex flex-col justify-center px-6 pt-24 pb-32 overflow-hidden [@media(max-height:900px)]:justify-start" aria-label="Request brochure form">
      <div className="mb-7">
      ...
      <form onSubmit={handleSubmit} noValidate aria-label="Brochure request">
        ...
        {form.venueStatus === "existing" && (
          <div className="mb-4 bg-accent/5 border border-accent/15 rounded-[12px] p-4">
            ...
            {/* TODO: wire Google Maps Places Autocomplete */}
        ...
        <button type="submit" disabled={submitting} aria-busy={submitting}
          className="btn-glass-accent w-full h-[54px] text-white font-semibold text-[16px] rounded-lg flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent">
          {submitting ? (
            <>
