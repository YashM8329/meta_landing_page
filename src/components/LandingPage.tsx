...
const venueReels: ReelItem[] = [
  ...
  { videoSrc: "/video/social_media/4.mp4", account: "Infinity Park", caption: "Installed in under 2 days. Request a brochure to bring this to your venue today. 📍🚀 #amusementpark #fec", likes: "3.2K", comments: "156", gameZone: "Reunion Island" },
  { videoSrc: "/video/social_media/5.mp4", account: "Timezone", caption: "Automatically auto-edited clips direct to player phones! Pure marketing power. 📱✨ #socialmedia #viral", likes: "4.1K", comments: "210", gameZone: "Australia" },
  { videoSrc: "/video/social_media/3.mp4", account: "Surfers Paradise", caption: "Gameplay footage from our new level! Replayability is off the charts. 🎮👾 #indiegamedev #gamers", likes: "986", comments: "47", gameZone: "Main Event, Austin" },
...
export default function LandingPage({ showCTA = true }: { showCTA?: boolean }) {
