...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="min-h-dvh relative hero-abyss flex flex-col lg:flex-row items-center justify-center lg:justify-between text-center lg:text-left px-6 lg:px-16 xl:px-24 pt-8 pb-8 lg:py-10 overflow-hidden gap-6 lg:gap-16"
      aria-label="Hero"
    >
