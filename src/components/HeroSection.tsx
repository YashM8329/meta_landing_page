...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto w-full relative z-10 flex flex-col lg:flex-row items-center justify-center lg:justify-between px-6 xl:px-0 gap-6 lg:gap-16">
        {/* Text column */}
        <motion.div
          variants={container}
          initial="hidden"
